    ...
    <div className="px-[5%] flex flex-col gap-20">
      ...
      <ul className="flex flex-col gap-10 ">
        {bills.map((bill, index) => (
          <li
            key={index}
            className="bg-[#fff9df] font-times p-10 pb-5 flex flex-col gap-5"
          >
            <div className="flex items-center gap-5">
              <button
                className="rounded-3xl border-1 border-black px-4 py-2 text-[1.5rem] text-[#4e3100] font-bold cursor-pointer"
                onClick={() =>
              ...
              <h4 className="text-[1.25rem] text-[#4e3100] font-bold">
                {bill.title}
              </h4>
            </div>

            <div className="text-[1.25rem] text-[#545454]">
            ...
            <div className="flex items-center cursor-pointer gap-3">
              ...
              <p className="text-[1.25rem] text-[#4e3100] font-bold">
                Text as Filed
              </p>
            </div>
          </li>
