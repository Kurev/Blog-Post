...
export const projectDirectory: ProjectItem[] = [
  ...
  // 7 to 18: randomized
  {
    ...
    scope: "Executive",
    sector: "Culture",
    summary: "A project to empower local culture and youth through workshops, exhibitions, and artisan support.",
    story: "Local elders trained youth in music, weaving, and dance. Craft fairs and exhibitions were organized, boosting income and cultural pride.",
    projectImg: [culture, treePlanting, school],
    lat: 7.212,
    lng: 124.245,
  },
  {
    projectTitle: "Greening Cotabato Project",
    img: treePlanting,
    overview: "Tree Planting & Environmental Awareness",
    date: "7/14/2022",
    area: "Bialong, Matalam, Cotabato",
    scope: "Legislative",
    sector: "Environment",
    summary: "A reforestation initiative involving community-based tree planting and environmental education.",
    story: "Volunteers planted thousands of native trees, monitored growth, and taught sustainable farming alongside reforestation efforts.",
    projectImg: [treePlanting, farming, electricity],
    lat: 7.207,
    lng: 124.243,
  },
  {
    projectTitle: "Agricultural Support Program",
    img: farming,
    overview: "Sustainable Farming",
    date: "2/18/2023",
    area: "Kibia, Makilala, Cotabato",
    scope: "Executive",
    sector: "Agriculture",
    summary: "Provides farmers with modern tools, seeds, and training for better yields and income stability.",
    story: "Farmers were trained in eco-friendly practices, crop diversification, and solar irrigation systems for sustainable farming.",
    projectImg: [farming, school, culture],
    lat: 7.21,
    lng: 124.25,
  },
  {
    projectTitle: "Community Hospital Renovation",
    img: hospital,
    overview: "Health Infrastructure Upgrade",
    date: "5/30/2023",
    area: "Malasila, Makilala, Cotabato",
    scope: "Legislative",
    sector: "Healthcare",
    summary: "Upgraded hospital facilities to improve healthcare access and quality.",
    story: "The project installed new medical equipment, renovated wards, and trained staff on new procedures.",
    projectImg: [hospital, electricity, treePlanting],
    lat: 7.2105,
    lng: 124.248,
  },
  {
    ...
    scope: "Executive",
    sector: "Education",
    summary: "Enhancing classrooms, providing modern tools, and improving student engagement.",
    story: "Schools were refurbished, digital tools provided, and workshops for teachers conducted.",
    projectImg: [school, hospital, farming],
    lat: 7.2089,
    lng: 124.2415,
  },
  {
    projectTitle: "Barangay Electrification Initiative",
    img: electricity,
    overview: "Rural Electrification",
    date: "9/22/2022",
    area: "New Israel, Makilala, Cotabato",
    scope: "Legislative",
    sector: "Energy",
    summary: "Bringing reliable electricity to remote barangays to boost safety and economic activity.",
    story: "Installation of streetlights, household connections, and solar backup systems empowered local communities.",
    projectImg: [electricity, treePlanting, school],
    lat: 7.205,
    lng: 124.238,
  },
  {
    projectTitle: "Cultural Heritage Support",
    img: culture,
    overview: "Community & Arts Empowerment",
    date: "10/10/2022",
    area: "Poblacion, Kidapawan City, Cotabato",
    scope: "Executive",
    sector: "Culture",
    summary: "Support for local artists and youth engagement in preserving cultural practices.",
    story: "Workshops and cultural fairs enhanced skill development, identity, and community income.",
    projectImg: [culture, school, hospital],
    lat: 7.212,
    lng: 124.245,
  },
  {
    projectTitle: "Greening Cotabato Project",
    img: treePlanting,
    overview: "Environmental Rehabilitation",
    date: "6/18/2022",
    area: "Bialong, Matalam, Cotabato",
    scope: "Legislative",
    sector: "Environment",
    summary: "Restoration of degraded forest areas with volunteer involvement.",
    story: "Tree planting drives and monitoring programs helped revive deforested lands.",
    projectImg: [treePlanting, culture, hospital],
    lat: 7.207,
    lng: 124.243,
  },
  {
    projectTitle: "Agricultural Support Program",
    img: farming,
    overview: "Farming & Productivity",
    date: "3/25/2022",
    area: "Kibia, Makilala, Cotabato",
    scope: "Executive",
    sector: "Agriculture",
    summary: "Training farmers in modern practices and improving access to resources.",
    story: "Provided seeds, tools, and training to increase productivity and income.",
    projectImg: [farming, treePlanting, electricity],
    lat: 7.21,
    lng: 124.25,
  },
  {
    projectTitle: "Community Hospital Renovation",
    img: hospital,
    overview: "Healthcare Upgrade",
    date: "7/7/2023",
    area: "Malasila, Makilala, Cotabato",
    scope: "Legislative",
    sector: "Healthcare",
    summary: "Hospital modernization for better service and equipment access.",
    story: "Renovation of wards, installation of modern medical equipment, and staff training programs.",
    projectImg: [hospital, school, culture],
    lat: 7.2105,
    lng: 124.248,
  },
  {
